...
export class ApiResponse<T> extends ServerResponse<T> {

  private statusCode: HTTP_STATUS_CODE = 200;
  private content: any;

  constructor(private _response: Response, value: T ) { 
    super(value);
  }
   ...
   */
  public withResData(content: T): ApiResponse<T> {
    this.Value = content;
     // this.content = this;
    return this;
  }
   ...
   * @param data - Data object
   */
  public withData(content: T): ApiResponse<T> {
   ...
   */
  public withStatusCode(statusCode: HTTP_STATUS_CODE): ApiResponse<T> {
   ...
   * @param statusCode - StatusCode
   */
  public withServiceStatus(serverStatus: ServerResponseStatus, mesage: string): ApiResponse<T> {
  ...
  public build(): Response {
    return this._response
      ...
      .type("json")
      .send(serialize(<ApiResponse<T>>this,
